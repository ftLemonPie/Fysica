...
\title{Elektrische krachtwerking}
\author{Daan Lipkens}

\begin{document}
\begin{abstract}
    Inleiding tot ladingen en kracht tussen ladingen.
\end{abstract}

\maketitle\label{hoofdstuk: elektrische_krachtwerking}
% ----------------------------------------------------------------------
%          inleiding hoofdstuk
% ----------------------------------------------------------------------
\section*{Inleiding}
De elektromagnetische kracht tussen geladen deeltjes is een van de vier fundamentele natuurkrachten. In dit hoofdstuk onderzoeken we eerst de basiseigenschappen van elektrische lading en de krachten die erop inwerken. Vervolgens bekijken we hoe objecten een lading kunnen krijgen, onder andere met behulp van de \emph{tribo-elektrische reeks}.
...
\begin{definition}
\emph{Elektrostatica} is het deel van de fysica dat het gedrag en de interacties van elektrische ladingen in rust en de krachtwerking ertussen bestudeert.
\end{definition}
