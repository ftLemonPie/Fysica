...
\end{abstract}
\maketitle
\section{Tribo-elektrisch effect}\label{sec:tribo-elektrisch-effect}
\begin{proposition}[foldable=true,title={Lading in een atoom}]\nl
...
%-----------------
%Definitie tribo-elektrisch effect
...
\begin{tikzpicture}
    ...
    \foreach \materiaal [count=\i from 0] in {
        ...
        % Zwarte indicator streepjes onder de pijl
...
%----------------------
%---------------
%QUIZ 3: TRIBO_ELEKTRISCHE REEKS
\begin{question}
