...
% BASIS OEFENING 1: FC
\begin{exercise}
    Twee ladingen $Q_{1}= +2{,}0  \, \mathrm{\mu C}$ en $Q_{2}= +3{,}0  \, \mathrm{\mu C}$ bevinden zich op een afstand van $0{,}500 \, \mathrm{m}$. Bereken de coulombkracht tussen beide ladingen.
...
% BASIS OEFENING  2: FC
\begin{exercise}
    Twee ladingen $Q_{1}= +4{,}00  \, \mathrm{\mu C}$ en $Q_{2}= -6{,}0  \, \mathrm{\mu C}$ bevinden zich op een afstand van $0{,}2 \, \mathrm{m}$. Bereken de coulombkracht en bepaal of het een aantrekking of afstoting is.

    \[ F_{c} = \answer[tolerance=0.05,onlineshowanswerbutton]{5} \, \mathrm{N} \]
...
\begin{exercise}
    Bereken de afstotingskracht tussen de 2 protonen in een $\mathrm{H}_{2}$-molecule. De afstand tussen de protonen is $0{,}74  \, \mathrm{nm}$.

    \[ F_{c} = \answer[tolerance=0.05,onlineshowanswerbutton]{4.2} \cdot 10^{-10} \, \mathrm{N} \]

    \begin{hint}
        Wat is de lading van één enkel proton? Deze is hetzelfde als de lading van een elektron.
    \end{hint}
    \begin{hint}
    ...
    \begin{solution}\nl
        \underline{Gegevens:}
        \begin{align*}
            & Q_{p} = 1{,}60 \cdot 10^{-19} \, \mathrm{C} & & r = 0{,}74 \cdot 10^{-9} \, \mathrm{m}
        \end{align*}
        ...
        \begin{align*}
            ...
            &=\frac{8{,}99 \cdot 10^9 \, \mathrm{\frac{N \cdot m^2}{C^2}} \cdot 1{,}60 \cdot 10^{-19} \, \mathrm{C} \cdot 1{,}60 \cdot 10^{-19} \, \mathrm{C}}{(0{,}74 \cdot 10^{-9} \, \mathrm{m})^{2}} \\
...
% BASIS OEFENING  4:  FC
\begin{exercise}
    Bereken de kracht tussen twee ladingen $Q_{1}= +1{,}0 \, \mathrm{\mu C}$ en $Q_{2}= -2{,}0 \, \mathrm{\mu C}$ die zich op $0{,}30 \, \mathrm{m}$ van elkaar bevinden.
    ...
    \begin{solution}\nl
        ...
        \begin{align*}
            ...
            &=\frac{8{,}99 \cdot 10^9 \, \mathrm{\frac{N \cdot m^2}{C^2}} \cdot 1{,}0 \cdot 10^{-6} \, \mathrm{C} \cdot 2{,}0 \cdot 10^{-6} \, \mathrm{C}}{(0{,}30 \, \mathrm{m})^{2}}\\
            &= 0{,}20 \, \mathrm{N} \simeq 2,0 \cdot 10^{-1} \, \mathrm{N}
        \end{align*}
...
\begin{exercise}
    ...
    \begin{hint}
        Omdat de ladingen identiek zijn ($Q_1 = Q_2 = Q$).
    \end{hint}
    \begin{hint}
        vereenvoudigt de wet van Coulomb naar: $F_{c} = k \cdot \frac{Q^2}{r^2}$.
    \end{hint}
    \begin{hint}
...
\begin{exercise}
    ...
    \begin{solution}\nl
        ...
        \begin{align*}
            ...
            \lvert Q \rvert &=  1{,}05 \cdot 10^{-5} \, \mathrm{C}
        \end{align*}
    \end{solution}
\end{exercise}
%———————————————————————————————————————
