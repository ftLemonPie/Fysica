...
\end{abstract}
\maketitle
\section{Oefeningen coulombkracht met goniometrische figuren}
...
\begin{exercise}
    Drie puntladingen $Q_{1}= +1{,}5  \, \mathrm{\mu C}$, $Q_{2}= +1{,}5  \, \mathrm{\mu C}$ en $Q_{3}= -2{,}0  \, \mathrm{\mu C}$ bevinden zich in de hoekpunten van een rechthoekige driehoek zoals te zien op de tekening. $Q_{1}$ en $Q_{3}$ liggen $3{,}0 \, \mathrm{dm}$ uit elkaar en $Q_{1}$ en $Q_{2}$ liggen $4{,}0 \, \mathrm{dm}$ uit elkaar. 
    ...
    \begin{solution}\nl
        ...
        \begin{align*}
            ...
            & Q_{3} = -2{,}0 \cdot 10^{-6} \, \mathrm{C} & & r_{12} =4{,}0\mathrm{dm} = 0{,}40 \, \mathrm{m}\\
            & r_{13} =3{,}0\mathrm{dm}= 0{,}30 \, \mathrm{m} & & 
        \end{align*}
        ...
        \textbf{Stap 2: Hoe staan de krachten op $Q_{3}$}  
        ...
        $Q_3$ heeft een ander soort lading dan $Q_1$ en $Q_2$, dus de krachten wijzen naar $Q_1$ en $Q_2$.
%----------------------------------------------------------------
    ...
    \textbf{Stap 3: Overstaande hoek}\\
        ...
        \begin{center}
            \begin{tikzpicture}[scale=0.8, transform shape] 
                ...
                % KRACHTEN
                \draw[kracht] (C)--(D) node[left] {$\vec{\mathbf{F}}_{12}$};
                \draw[kracht] (C) -- (E) node[above, right] {$\vec{\mathbf{F}}_{13}$};
                \draw[resulterendekracht] (C) -- (F) node[right] {$\vec{\mathbf{F}}_{\text{res}}$};
            \end{tikzpicture}
        \end{center}
%----------------------------------------------------------------
