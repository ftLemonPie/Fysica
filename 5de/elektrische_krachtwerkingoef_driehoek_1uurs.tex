...
%herschreven 3 september 2026: van makkelijk naar moeilijk, 1 extra oefening toegevoegd
...
%———————————————————————————————————————
% OEFENING 2: rechthoekige driehoek (3-4-5), hoek zoeken + cosinusregel
\begin{exercise}
...
%———————————————————————————————————————
% OEFENING 3 (nieuw): rechthoekige driehoek zonder "mooie" verhouding
\begin{exercise}
    Drie puntladingen $Q_{1}= +1{,}0 \cdot 10^{-6} \, \mathrm{C}$, $Q_{2}= +1{,}0 \cdot 10^{-6} \, \mathrm{C}$ en $Q_{3}= -2{,}5 \cdot 10^{-6} \, \mathrm{C}$ bevinden zich in de hoekpunten van een rechthoekige driehoek, met de rechte hoek bij $Q_1$. $Q_{1}$ en $Q_{3}$ liggen $0{,}20 \, \mathrm{m}$ uit elkaar en $Q_{1}$ en $Q_{2}$ liggen $0{,}45 \, \mathrm{m}$ uit elkaar.
    ...
    \[ F_{\text{res},3} = \answer[tolerance=0.05,onlineshowanswerbutton]{0.61} \, \mathrm{N} \]

    \begin{hint}
        Deze oefening werkt met exact dezelfde methode als de vorige, maar de zijden vormen nu geen 3-4-5-driehoek. Reken zorgvuldig met tussenresultaten in plaats van afgeronde waarden.
    \end{hint}
    \begin{hint}
        Bereken $r_{23}$ eerst met de stelling van Pythagoras, en gebruik die exacte (niet-afgeronde) waarde verder in je berekening van $F_{23}$.
    \end{hint}
    \begin{hint}
        Bepaal de hoek $\theta$ bij $Q_3$ opnieuw via $\tan\theta = \frac{r_{12}}{r_{13}}$, bereken de overstaande hoek, en pas de cosinusregel toe.
    \end{hint}

    \begin{solution}\nl
        \underline{Gegevens:}
        \begin{align*}
            & Q_{1} = +1{,}0 \cdot 10^{-6} \, \mathrm{C} & & Q_{2} = +1{,}0 \cdot 10^{-6} \, \mathrm{C} \\
            & Q_{3} = -2{,}5 \cdot 10^{-6} \, \mathrm{C} & & r_{12} = 0{,}45 \, \mathrm{m}\\
            & r_{13} = 0{,}20 \, \mathrm{m} & &
        \end{align*}
        ...
        \underline{Oplossing:}\\
        \textbf{Stap 1: Grootte van $F_{13}$}
        \begin{align*}
            F_{13} &= \frac{k \cdot \lvert Q_{1}\rvert \cdot \lvert Q_{3}\rvert}{(r_{13})^{2}} \\
            &= \frac{8{,}99 \cdot 10^9 \, \mathrm{\frac{N \cdot m^2}{C^2}} \cdot 1{,}0 \cdot 10^{-6} \, \mathrm{C} \cdot 2{,}5 \cdot 10^{-6} \, \mathrm{C}}{(0{,}20 \, \mathrm{m})^{2}} \\
            &= 0{,}5619 \, \mathrm{N}
        \end{align*}

        \textbf{Stap 2: Ontbrekende afstand en grootte van $F_{23}$}
        \begin{align*}
            r_{23} &= \sqrt{r_{12}^{2}+r_{13}^{2}} = \sqrt{(0{,}45 \, \mathrm{m})^{2}+(0{,}20 \, \mathrm{m})^{2}} = 0{,}4924 \, \mathrm{m}
        \end{align*}
        \begin{align*}
            F_{23} &= \frac{k \cdot \lvert Q_{2}\rvert \cdot \lvert Q_{3}\rvert}{(r_{23})^{2}} \\
            &= \frac{8{,}99 \cdot 10^9 \, \mathrm{\frac{N \cdot m^2}{C^2}} \cdot 1{,}0 \cdot 10^{-6} \, \mathrm{C} \cdot 2{,}5 \cdot 10^{-6} \, \mathrm{C}}{(0{,}4924 \, \mathrm{m})^{2}} \\
            &= 0{,}0927 \, \mathrm{N}
        \end{align*}

        \textbf{Stap 3: Hoek bepalen}
        \begin{align*}
            \tan(\theta) &= \frac{r_{12}}{r_{13}} = \frac{0{,}45 \, \mathrm{m}}{0{,}20 \, \mathrm{m}} \\
            \theta &= 66{,}0^\circ
        \end{align*}
        De overstaande hoek in het parallellogram is $180^\circ - 66{,}0^\circ = 114{,}0^\circ$.

        \textbf{Stap 4: Cosinusregel toepassen}
        \begin{align*}
            F_{\text{res},3} &= \sqrt{F_{13}^{2} + F_{23}^{2} - 2 \cdot F_{13} \cdot F_{23} \cdot \cos(114{,}0^\circ)} \\
            &= \sqrt{(0{,}5619 \, \mathrm{N})^{2} + (0{,}0927 \, \mathrm{N})^{2} - 2 \cdot 0{,}5619 \, \mathrm{N} \cdot 0{,}0927 \, \mathrm{N} \cdot \cos(114{,}0^\circ)} \\
            &\simeq 0{,}61 \, \mathrm{N}
        \end{align*}
        De resulterende kracht op lading $Q_{3}$ is ongeveer $6{,}1 \cdot 10^{-1} \, \mathrm{N}$.
    \end{solution}
\end{exercise}
%———————————————————————————————————————

%———————————————————————————————————————
% OEFENING 4: gelijkzijdige driehoek, lastigere hoek-interpretatie
\begin{exercise}
...
%———————————————————————————————————————
% OEFENING 5 (moeilijkst): vierkant, meerdere stappen, meerdere deelvragen
\begin{exercise}
