...
\section{Veldlijnen van een radiaal veld}\label{s:radiaal_veld}

Bij een enkele positieve puntlading wijzen de veldlijnen radiaal naar buiten, zoals te zien op figuur \ref{fig:veldlijnen_puntlading}(a). Bij een negatieve puntlading wijzen ze radiaal naar binnen, zoals te zien op figuur \ref{fig:veldlijnen_puntlading}(b). Omdat de lijnen in 3D uitwaaieren, wordt de dichtheid van de lijnen kleiner naarmate je verder van de bron weggaat, wat overeenkomt met de afname in veldsterkte ($E \propto \frac{1}{r^2}$).
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.2]
            ...
            \foreach \angle in {0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330} {
                % Pad van binnen naar buiten -> gecentreerde pijl wijst naar buiten
                \draw[Eveldlijn] (O1) -- ++(\angle:2.5);
            }
            ...
            % Label q
            \node[above] at (0.7, 0.0) {$q$};
            
            %Label E
            \node[below] at (1.4, -0.05) {\textcolor{orange}{$E$}};
            ...
            \foreach \angle in {0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330} {
                % Pad van buiten naar binnen -> gecentreerde pijl wijst naar binnen
                \draw[Eveldlijn] ($(O2)+(\angle:2.5)$) -- (O2);
            }
            ...
            % Label -q
            \node[above] at (7.2, 0.0) {$-q$};
            
            %E label
            \node[below] at (7.9, -0.05) {\textcolor{orange}{$E$}};
