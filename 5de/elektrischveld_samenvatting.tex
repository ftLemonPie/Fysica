...
\samenbox{Het elektrisch veld}{
    ...
    $$ \vec{E} = \frac{\vec{F}_e}{Q_t} \qquad \text{eenheid: } \mathrm{N/C} $$
    De zin van de kracht op de testlading is gelijk aan die van het elektrisch veld bij een positieve lading, en tegengesteld bij een negatieve lading.
}
...
\samenbox{Veldlijnen}{
    \begin{itemize}
        \item Volgens de raaklijn aan $\vec{E}$ in elk punt. De pijl geeft de zin aan.
