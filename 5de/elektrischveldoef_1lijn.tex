...
\begin{exercise}
    ...
    \begin{center}
       \begin{tikzpicture}[scale=1]
            ...
            \node[poslading] at (0,0) {$+$};
            \node[neglading] at (3,0) {$-$};
...
\begin{exercise}
    ...
    \begin{solution}\nl
        ...
        \[
            x = \frac{d}{3} = \frac{1{,}20 \, \mathrm{m}}{3} = 0{,}40 \, \mathrm{m} = 4{,}0\cdot 10^{-1} \, \mathrm{m}
        \]
        Het gezocht punt ligt dus op $4{,}0\cdot 10^{-1} \, \mathrm{m}$ van $Q_1$ (en dus $0{,}80 \, \mathrm{m}$ van $Q_3$), zoals verwacht dichter bij de kleinste lading.
    \end{solution}
\end{exercise}
%———————————————————————————————————————
...
\begin{exercise}
    ...
    \begin{question}
        ...
        \[ Q_2 = \answer[tolerance=1,onlineshowanswerbutton]{3.2} \cdot 10^{-5} \, \mathrm{C} \]
        ...
        \begin{solution}\nl
            ...
            \begin{align*}
                ...
                Q_2 &= Q_1 \cdot \left(\frac{r_2}{r_1}\right)^{2} \\
                    ...
                    &= 32 \cdot 10^{-6} \, \mathrm{C} = 3{,}2 \cdot 10^{-5} \, \mathrm{C}
            \end{align*}
        \end{solution}
    \end{question}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{solution}\nl
        ...
        Hieruit volgt $d - x = 2x$, dus $d = 3x$, en
        \[
            x = \frac{d}{3} = \frac{0{,}90 \, \mathrm{m}}{3} = 0{,}30 \, \mathrm{m} = 3{,}0\cdot 10^{-1} \, \mathrm{m}
        \]
        Het gezochte punt ligt dus op $3{,}0\cdot 10^{-1} \, \mathrm{m}$ van $Q_1$, zoals verwacht dichter bij de kleinste lading.
    \end{solution}
\end{exercise}
%———————————————————————————————————————
...
\begin{exercise}
    ...
    \begin{question}
        ...
        \begin{solution}\nl
            ...
            \[
                x = d = 0{,}60 \, \mathrm{m} = 6{,}0\cdot 10^{-1} \, \mathrm{m}
            \]
            Het gezochte punt ligt dus $6{,}0\cdot 10^{-1} \, \mathrm{m}$ links van $Q_1$.
        \end{solution}
    \end{question}
\end{exercise}
%———————————————————————————————————————
