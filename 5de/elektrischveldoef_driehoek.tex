...
\begin{exercise}
    ...
    \begin{solution}\nl
        ...
        \end{align*}
        $\vec{E}_1$ wijst van $P$ weg (langs $PQ_1$), $\vec{E}_3$ wijst van $P$ naar $Q_3$ toe (langs $PQ_3$). Doordat één vector "weg" en de andere "naar toe" wijst, is de overstaande hoek die je in de cosinusregel gebruikt hier gelijk aan de driehoekshoek zelf, dus $65^\circ$ (in plaats van $180^\circ-65^\circ$ zoals bij twee gelijknamige ladingen).
