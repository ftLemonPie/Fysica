...
\begin{exercise}
    Twee puntladingen $Q_{1} = +3{,}0 \cdot 10^{-6} \, \mathrm{C}$ en $Q_{2} = +6{,}0 \cdot 10^{-6} \, \mathrm{C}$ bevinden zich respectievelijk op de $y$-as en de $x$-as ten opzichte van punt \textit{P}, zoals aangegeven op de tekening. $Q_1$ bevindt zich op $0{,}25 \, \mathrm{m}$ van $P$, en $Q_2$ op $0{,}40 \, \mathrm{m}$ van $P$.
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1]
            ...
            \tkzFillAngle[fill=blue!20,opacity=0.5](Q2,P,Q1)
            \tkzLabelAngle[pos=0.6](Q2,P,Q1){$90^\circ$}
    ...
    \end{hint}
    \begin{hint}
        Omdat $Q_2$ op de $x$-as en $Q_1$ op de $y$-as ligt (een rechte hoek in $P$), staan $\vec{E}_1$ en $\vec{E}_2$ loodrecht op elkaar. Je kan de resultante dan rechtstreeks berekenen met de stelling van Pythagoras.
    \end{hint}
    ...
    \begin{solution}\nl
        ...
        \end{align*}
        Beide ladingen zijn positief, dus wijst $\vec{E}_1$ weg van $Q_1$ (langs de $y$-as) en $\vec{E}_2$ weg van $Q_2$ (langs de $x$-as). Deze twee vectoren staan dus loodrecht op elkaar.
...
\begin{exercise}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1]
            ...
            \tkzDefPoint(0,2.0){Q1}
            \tkzDefPoint(3.0,0){Q2}
            \draw[gray,thick] (P) -- (Q1) node[midway,left]{$0{,}20\,\mathrm{m}$};
            \draw[gray,thick] (P) -- (Q2) node[midway,below]{$0{,}30\,\mathrm{m}$};
            \tkzMarkRightAngle[size=0.3](Q2,P,Q1)
            \tkzLabelPoint[below](P){$P$}
            \tkzLabelPoint[left](Q1){$Q_1$}
            \tkzLabelPoint[below](Q2){$Q_2$}
            \node[poslading] at (Q1) {$+$};
...
\begin{exercise}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.4]
            ...
            \tkzDefPoint(0,1.5){Q1}
            \tkzDefPoint(2.5,0){Q3}
            \draw[gray,thick] (P) -- (Q1) node[midway,left]{$0{,}15\,\mathrm{m}$};
            \draw[gray,thick] (P) -- (Q3) node[midway,below]{$0{,}25\,\mathrm{m}$};
            \tkzMarkRightAngle[size=0.25](Q3,P,Q1)
            \tkzLabelPoint[below](P){$P$}
            \tkzLabelPoint[left](Q1){$Q_1$}
            \tkzLabelPoint[below](Q3){$Q_3$}
            \node[poslading] at (Q1) {$+$};
            \node[neglading] at (Q3) {$-$};
            \filldraw (P) circle (1.2pt);
        \end{tikzpicture}
...
\begin{exercise}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1]
            ...
            \tkzDefPoint(0,1.5){Q1}
            \tkzDefPoint(2.0,0){Q2}
            \draw[gray,thick] (P) -- (Q1) node[midway,left]{$15\,\mathrm{cm}$};
            \draw[gray,thick] (P) -- (Q2) node[midway,below]{$20\,\mathrm{cm}$};
            \tkzMarkRightAngle[size=0.25](Q2,P,Q1)
            \tkzLabelPoint[below=1.5mm](P){$P$}
            \tkzLabelPoint[left=1.5mm](Q1){$Q_1$}
...
\begin{exercise}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.3]
            ...
            \tkzDefPoint(0,1.6){Q1}
            \tkzDefPoint(2.4,0){Q3}
            \draw[gray,thick] (P) -- (Q1) node[midway,left]{$80\,\mathrm{mm}$};
            \draw[gray,thick] (P) -- (Q3) node[midway,below]{$12\,\mathrm{cm}$};
            \tkzMarkRightAngle[size=0.2](Q3,P,Q1)
            \tkzLabelPoint[below=1.5mm](P){$P$}
            \tkzLabelPoint[left=1.5mm](Q1){$Q_1$}
            \tkzLabelPoint[below=1.5mm](Q3){$Q_3$}
            \node[poslading] at (Q1) {$+$};
            \node[neglading] at (Q3) {$-$};
            \filldraw (P) circle (1.2pt);
        \end{tikzpicture}
...
\begin{exercise}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.7]
            ...
            \tkzDefPoint(0,3.6){A}
            \tkzDefPoint(4.8,0){B}
            \tkzDefPoint(4.8,3.6){C}
            \tkzDrawPolygon(P,A,C,B)
            \tkzMarkRightAngle[size=0.3](B,P,A)
            \tkzLabelPoint[below=1.5mm](P){$P$}
            \tkzLabelPoint[left=1.5mm](A){$Q_A$}
            \tkzLabelPoint[below=1.5mm](B){$Q_B$}
            \node[poslading] at (A) {$+$};
            \node[neglading] at (B) {$-$};
...
\begin{exercise}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1]
            ...
            \tkzDefPoint(0,1.8){Q1}
            \tkzDefPoint(2.4,0){Q2}
            \draw[gray,thick] (P) -- (Q1) node[midway,left]{$18\,\mathrm{cm}$};
            \draw[gray,dashed] (P) -- (Q2) node[midway,below]{$?$};
...
\begin{exercise}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.2]
            ...
            \tkzDefPoint(0,3.0){Q1}
            \tkzDefPoint(4.0,0){Q2}
            \draw[gray,thick] (P) -- (Q1) node[midway,left]{$0{,}30\,\mathrm{m}$};
            \draw[gray,dashed] (P) -- (Q2) node[midway,below]{$?$};
        ...
        \begin{solution}\nl
            ...
            \begin{align*}
                r_{2} &= \sqrt{(Q_1Q_2)^{2} - r_{1}^{2}} \\
                      ...
                      &= 0{,}40 \, \mathrm{m} = 4{,}0\cdot 10^{-1} \, \mathrm{m}
            \end{align*}
        \end{solution}
    \end{question}
