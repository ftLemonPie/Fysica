%Basis geschreven zonder verbetering
...
\begin{align*}
A(t) = -\dv{N(t)}{t} && A(t) = A_0 e^{\frac{-t\cdot \ln{2}}{T_{1/2}}} && A_{gem} = -\frac{\Delta N(t)}{\Delta t}
\end{align*}
...
\begin{itemize}
  ...
  \mylink{https://www.bcu.ac.uk/exams-and-revision/best-ways-to-revise/spaced-repetition}{Link naar spaced repetition methode}
  \end{remark}
