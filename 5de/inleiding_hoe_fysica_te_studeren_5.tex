...
Fysica is géén \textit{stampvak}. Het is een \textbf{vaardigheidsvak}.  
...
\begin{algorithm}[foldable=true,title={Stappenplan voor fysica-problemen}]\nl
\begin{enumerate}%[label=\Roman*]
    \item \textbf{Analyseer de opgave} \begin{itemize}
      \item \textbf{Lees zorgvuldig}: Wat wordt gevraagd? Markeer dit in het rood. Welke gegevens heb je? Markeer dit in het groen.
      \item \textbf{Gegeven en Gevraagd:} Noteer je gegevens en gevraagde met de correcte symbolen en eenheden. Zet alle gegevens nu al om naar hun SI-eenheid.
    ...
    \item \textbf{De wiskundige uitwerking} \begin{itemize}
...
\subsection*{Stap 2 - Kies de juiste wet en formules}
...
\end{itemize}
\subsection*{Stap 4 - Controleer je antwoord}
...
\begin{itemize}
  ...
  Lees niet enkel de theorie, maar werk voorbeelden opnieuw uit \textit{zonder} naar de oplossing te kijken.  
  ...
  Vraag jezelf af: “Wat als de kracht dubbel zo groot is?” of “Wat als het object zich nu op een helling bevindt?”
\end{itemize}
