...
- [ ] inleiding maken
    - [x] hoe fysica te studeren nakijken
    - [x] practische richtlijnen nakijken
- [ ] download pdf zonder antwoorden --> ?
- [ ] beter manier afbeelding in title
- [ ] pdf is nog steeds slecht
- [ ] footnote in html laten uitklappen
...
## Errors
- [ ] de hele xourse wilt niet laden, blijft oude versie
- [ ] in lading.tex:
    - [ ]: \youtube link werkt niet in html
    - [ ]: .jpg en .jpep willen niet laden in html 
